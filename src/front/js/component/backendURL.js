...
export const BackendURL = () => (
	<div className="mt-5 pt-5 w-50 mx-auto">
		...
		<p>
			...
			<a target="_blank" href="https://www.awesomescreenshot.com/video/16498567?key=72dbf905fe4fa6d3224783d02a8b1b9c">
		...
		<p>
			There's one variable called <Dark>REACT_APP_BACKEND_URL</Dark> that needs to be manually set by yourself.
		</p>
		<ol>
			...
			<li>
				Add a new variable REACT_APP_BACKEND_URL=<Dark>your api host</Dark>
			</li>
			<li>
